...
-- withSiteContext (Object obj) siteContext = do
--   let Object context = (toJSON siteContext)

--   Object $ union obj context
...
-- -- filePathFromList :: [String] -> FilePath 
-- -- filePathFromList = 
...
--     copyFileChanged ("site" </> filepath) (outputFolder </> newFilePath)
